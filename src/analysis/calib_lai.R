...
merged_tisza_filt05_leafon<-subset(merged_tisza_leafon, OBJNAME %in% c(118,119,120,121,122,123,132,133,134,149,150,151,152,153,154,155,156,157,157,158,158,159,176,176,177,177,179,179,180,180,181,181,182,182,183, 183,184,184,185,186,187))
...
p1=ggplot(data=merged_balaton_filt05,aes(x=C_ppr2,y=gct_lai))+geom_point(aes(shape=class),size=4)+theme_minimal()+geom_smooth(method="lm",se=TRUE)+
  geom_text(aes(label=OBJNAME),hjust=0, vjust=0)+xlab("C_ppr2")+ylab("LAI")
p2=ggplot(data=merged_balaton_filt05,aes(x=A_std,y=gct_lai))+geom_point(aes(shape=class),size=4)+theme_minimal()+geom_smooth(method="lm",se=TRUE)+
  geom_text(aes(label=OBJNAME),hjust=0, vjust=0)+xlab("A_std")+ylab("LAI")
p3=ggplot(data=merged_balaton_filt05,aes(x=EchoWidth2EchoWidthmedian.grd,y=gct_lai))+geom_point(aes(shape=class),size=4)+theme_minimal()+geom_smooth(method="lm",se=TRUE)+
