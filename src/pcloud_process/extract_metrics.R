...
#workingdirectory="D:/Sync/_Amsterdam/_PhD/Chapter2_habitat_str_lidar/3_Dataprocessing/pcloud/balaton_25mrad_reclass/"
...
dpcloudfea_exp_df <- data.frame(matrix(ncol = 19, nrow = 0))
x <- c("OBJNAME", "point_ID","point_name", "H_max","H_mean","H_median","H_q25","H_q75","H_q95",
       "V_std","V_var","V_sk","V_ku","C_ppr","A_std","A_med","A_cover","nofveg","nofallp")
...
#write.csv(dpcloudfea_exp_df,paste("Balaton_lidarmetrics_",rad,"_reclass2.csv",sep=""))
