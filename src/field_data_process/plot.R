...
write.csv(data_quadtrat_tolidar,"C:/Koma/Sync/_Amsterdam/_PhD/Chapter2_habitat_str_lidar/3_Dataprocessing/Analysis6/data_quadtrat_tolidar_forarticle.csv")
